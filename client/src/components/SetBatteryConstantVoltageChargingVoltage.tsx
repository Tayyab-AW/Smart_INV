...
const SetBatteryConstantVoltageChargingVoltage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const res = await setInverterParameters("PCVV", frequency);
  ...
  return (
    <div className="bg-[grey] flex flex-col mt-[50px] w-screen h-auto p-[20px] rounded-md">
      ...
      <span style={{ fontSize: "24px" }}>
        Set Constant Voltage Charging Voltage:
      </span>
...
export default SetBatteryConstantVoltageChargingVoltage;
