...
const SetMaxChargingTimeAtConstantVoltageStage = () => {
  ...
  return (
    <div className="bg-[grey] flex flex-col mt-[50px] w-screen h-auto p-[20px] rounded-md">
      ...
      <span style={{ fontSize: "24px" }}>Set Battery Bulk Voltage:</span>
...
export default SetMaxChargingTimeAtConstantVoltageStage;
